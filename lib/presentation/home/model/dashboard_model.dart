...
class DashboardModel {
    ...
    return DashboardModel(
      ...
      recommendedBook: json['recommended_book'] != null
          ? (json['recommended_book'] as List<dynamic>)
              ...
              .toList()
          : [],
      recentlyAddBook: json['recently_added_book'] != null
          ? (json['recently_added_book'] as List<dynamic>)
              .map((e) => BookModel.fromJson(e))
              .toList()
          : [],
  ...
  @override
  String toString() {
    return '${mainBook.toString()} ${popularBook.toString()} ${topSearchBook.toString()} ${topSellBook.toString()} ${recentlyAddBook.toString()} ${recommendedBook.toString()} ${categories.toString()} ';
  }
}
