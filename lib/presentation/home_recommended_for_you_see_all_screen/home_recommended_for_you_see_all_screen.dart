...
class HomeRecommendedForYouSeeAllScreen extends StatelessWidget {
  HomeRecommendedForYouSeeAllScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          AppbarSubtitle(text: "Recommended For You"),
                          Padding(
            ...
            body: Padding(
                padding: getPadding(left: 17, top: 4, right: 20),
